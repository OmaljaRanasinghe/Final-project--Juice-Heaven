...
<head>
    ...
    <title>Juice Heaven - Login</title>
        ...
        <div class="w-full max-w-md">
            ...
            <div class="text-center mb-8 animate-slideInDown">
                <div class="flex items-center justify-center mb-4">
                    <img src="{{ asset('logo/logo.png') }}" alt="Juice Heaven Logo" class="h-12 w-12 rounded-full shadow-lg mr-3 animate-bounce-slow">
                    <div>
                ...
                <p class="text-gray-600 text-sm">Welcome back to Juice Heaven</p>
            </div>
